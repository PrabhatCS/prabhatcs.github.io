          ...
          >
            ...
            <div className="space-y-4 pt-4">
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button variant="outline" size="lg" asChild className="group border-2 hover:bg-primary/5">
                  <a href="/attached_assets/PrabhatDS_2026_.pdf" target="_blank" rel="noopener noreferrer">
