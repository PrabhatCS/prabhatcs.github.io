...
const brandIconUrls: Record<string, string> = {
  ...
  "Databricks & Delta Lake": "https://images.seeklogo.com/logo-png/61/1/databricks-icon-logo-png_seeklogo-611588.png",
  ...
  "Neo4j & Graph DBs": "https://tse1.mm.bing.net/th/id/OIP.K-2GDktS3fDMKMDgdBBnIQHaCl?cb=defcachec2&rs=1&pid=ImgDetMain&o=7&rm=3",
  "C3.ai": "https://c3.ai/wp-content/uploads/2022/07/C3-AI-Logo-1024x1024-1.png",
  "Palantir Foundry & AIP": "https://www.svgrepo.com/download/342103/palantir.svg",
...
const skillIconMap: Record<string, string | keyof typeof IconsComponent> = {
  ...
  "Palantir Foundry & AIP": "Palantir Foundry & AIP",
  "C3.ai": "C3.ai",
